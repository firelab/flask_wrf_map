...
nc <-nc_open("/home/nwagenbrenner/nightly_wrf/output/wrfout.nc")
...
r<-brick(get(paste0("r1")), get(paste0("r2")), get(paste0("r3")), get(paste0("r4")), 
         get(paste0("r5")), get(paste0("r6")), get(paste0("r7")), get(paste0("r8")), 
         get(paste0("r9")), get(paste0("r10")))
